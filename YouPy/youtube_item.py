...
class YouTubeItem:
    ...
    def __init__(
        ...
        """Construct a :class:`YouTubeItem <YouTubeItem>`.
        ...
        self.stream_progress_state = ProgressState(
    ...
    def initialize_stream_objects(self, fmt: str) -> None:
        ...
        for stream in stream_manifest:
            video = Stream(
                ...
                progress_state=self.stream_progress_state,
            )
    ...
    def register_on_progress_callback(self, func: OnProgress):
        ...
        """
        self.stream_progress_state.on_progress = func
    ...
    def register_on_complete_callback(self, func: OnComplete):
        ...
        """
        self.stream_progress_state.on_complete = func
