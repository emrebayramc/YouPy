...
from YouPy import Caption, CaptionQuery, captions
...
@mock.patch("YouPy.captions.Caption.generate_srt_captions")
...
@mock.patch("YouPy.captions.Caption.xml_captions")
...
@mock.patch("YouPy.captions.request")
