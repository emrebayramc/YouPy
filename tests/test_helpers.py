...
from YouPy import helpers
from YouPy.exceptions import RegexMatchError
from YouPy.helpers import deprecated, cache, target_directory, setup_logger
...
@mock.patch("YouPy.helpers.logging")
def test_setup_logger(logging):
    ...
    setup_logger(20)
    # Then
    logging.getLogger.assert_called_with("YouPy")
